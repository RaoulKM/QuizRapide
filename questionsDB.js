...
export const questionsDB = {
  ...
  bdd: [
    // 100 questions sur les bases de données
    {
      ...
      correct: 0,
      explanation:
        "La clé primaire identifie de façon unique chaque ligne d'une table et ne peut pas contenir de valeur nulle.",
    },
    {
      id: 2,
      question:
    ...
    },
    {
      ...
      correct: 0,
      explanation:
        "Une transaction est un ensemble d'opérations qui doivent être réalisées entièrement ou pas du tout (ACID).",
    },
    {
      id: 4,
      ...
      correct: 0,
      explanation:
        "La normalisation organise les données pour minimiser la redondance et améliorer l'intégrité.",
    },
    {
      id: 5,
    ...
    },
    {
      ...
      options: [
        ...
        "Accès, Contrôle, Intégrité, Disponibilité",
        "Authentification, Chiffrement, Isolation, Disponibilité",
        "Aucune de ces réponses",
      ],
      correct: 0,
      explanation:
        "ACID désigne les propriétés fondamentales d'une transaction : Atomicité, Cohérence, Isolation, Durabilité.",
    },
    {
      id: 7,
      question:
        "Quel type de jointure retourne toutes les lignes de la première table, même sans correspondance dans la seconde ?",
      options: ["LEFT JOIN", "INNER JOIN", "RIGHT JOIN", "FULL JOIN"],
      correct: 0,
      explanation:
        "LEFT JOIN retourne toutes les lignes de la première table et les correspondances de la seconde.",
    },
    {
      id: 8,
      ...
      correct: 0,
      explanation:
        "Un index permet d'accélérer les recherches sur une ou plusieurs colonnes.",
    },
    {
      id: 9,
      question: "Quel mot-clé SQL permet de supprimer une table ?",
      options: ["DROP", "DELETE", "REMOVE", "TRUNCATE"],
      correct: 0,
      explanation: "DROP supprime complètement une table et ses données.",
    },
    {
      id: 10,
      question:
        "Quel type de base de données utilise des collections et des documents ?",
      options: ["NoSQL", "Relationnelle", "Hiérarchique", "Réseau"],
      correct: 0,
      explanation:
        "Les bases NoSQL (ex: MongoDB) utilisent des collections et des documents.",
    },
  ...
  memoire: [
    {
      id: 1,
      question: "Qu'est-ce que le 'Thrashing' en mémoire virtuelle?",
      options: [
        "Un excès d'E/S dû à un manque de frames",
        "Une fragmentation externe",
        "Un processus qui ne trouve pas ses pages",
        "Une mauvaise utilisation de la mémoire",
      ],
      correct: 0,
      explanation:
        "Le Thrashing se produit quand le système passe son temps à échanger des pages.",
    },
    {
      id: 2,
      question: "Quel est l'objectif principal de la mémoire virtuelle?",
      options: [
        "Augmenter la taille de la mémoire physique",
        "Permettre aux processus d'utiliser plus de mémoire qu'il n'y en a physiquement",
        "Accélérer l'accès à la RAM",
        "Éliminer la fragmentation",
      ],
      correct: 1,
      explanation:
        "La mémoire virtuelle donne l'illusion d'un grand espace d'adressage.",
    },
    {
      id: 3,
      question: "Qu'est-ce que la pagination (paging)?",
      options: [
        "Diviser la mémoire en blocs de taille fixe",
        "Diviser la mémoire en blocs de taille variable",
        "Échanger des données entre disques",
        "Gérer l'espace d'adressage logique",
      ],
      correct: 0,
      explanation:
        "La pagination divise la mémoire en pages et frames de taille fixe.",
    },
    {
      id: 4,
      question: "Quelle est la fonction principale d'une table de pages?",
      options: [
        "Associer une adresse logique à une adresse physique",
        "Gérer les E/S",
        "Stocker les registres",
        "Gérer les priorités",
      ],
      correct: 0,
      explanation:
        "La table de pages fait la correspondance entre adresses logiques et physiques.",
    },
    {
      id: 5,
      question: "Quel est le problème de la fragmentation externe?",
      options: [
        "Des trous de mémoire trop petits pour être alloués",
        "Une mémoire qui ne peut pas être paginée",
        "Un manque de frames",
        "De l'espace inutilisé dans les blocs",
      ],
      correct: 0,
      explanation:
        "La fragmentation externe divise la mémoire libre en petits blocs non contigus.",
    },
    // ... 95 autres questions pour memoire ...
  ],
  planif: [
    {
      id: 1,
      question:
        "Quel outil permet de visualiser les tâches d'un projet dans le temps?",
      options: [
        "Diagramme de Gantt",
      ...
      correct: 0,
      explanation:
        "Le diagramme de Gantt est utilisé pour planifier et suivre l'avancement des tâches.",
    },
    {
      id: 2,
      question:
        "Quelle méthode de gestion de projet est basée sur des itérations courtes?",
      options: ["Cycle en V", "Cascade", "Agile", "PERT"],
      correct: 2,
      explanation:
        "La méthode Agile privilégie des cycles courts et une adaptation continue.",
    },
    {
      id: 3,
      ...
      options: [
        "Une tâche critique",
        "Un point clé marquant une étape importante",
        "Un livrable",
        "Un diagramme",
      ],
      correct: 1,
      explanation:
        "Un jalon est une date ou un événement important dans la planification d'un projet.",
    },
    {
      id: 4,
      question: "La gestion des risques consiste à...",
      options: [
      ...
      correct: 1,
      explanation:
        "La gestion des risques vise à anticiper et à limiter les impacts négatifs sur le projet.",
    },
    {
      id: 5,
      question: "Qu'est-ce que le chemin critique dans un projet?",
      options: [
        "La séquence d'activités la plus longue",
        "La tâche la plus coûteuse",
        "Le diagramme de Gantt",
        "Le budget du projet",
      ],
      correct: 0,
      explanation:
        "Le chemin critique est la séquence d'activités qui détermine la durée minimale du projet.",
    },
    // ... 95 autres questions pour planif ...
  ],
};
